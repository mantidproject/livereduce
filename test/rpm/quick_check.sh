...
SPEC_FILE="/home/dzj/livereduce/livereduce.spec"
...
# Check service file
if [[ -f "/home/dzj/livereduce/livereduce.service" ]]; then
    echo -e "${GREEN}✓ Service file exists${NC}"

    if grep -q "User=snsdata" "/home/dzj/livereduce/livereduce.service"; then
